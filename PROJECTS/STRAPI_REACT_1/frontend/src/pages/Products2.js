...
const LoadingText = () => {
  return (
    <div className="flex items-center justify-center h-screen bg-white">
      <p className="text-3xl font-semibold text-gray-800 animate-pulse-slow">
        Yüklənir...
      </p>
    </div>
  );
...
function Load(){
    return(
        <div className="h-10 w-10 border-4 border-blue-500 border-t-transparent rounded-full animate-spin-slow"></div>
    );
}
